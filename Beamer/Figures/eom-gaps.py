...
yticks_translation = {
    # (omega, N)
    (1.0, 2): dict(points=[0.578, 0.590], decimals=3),
    (1.0, 6): dict(points=[0.518, 0.603], decimals=3),
    (1.0, 12): dict(points=[0.512, 0.737], decimals=3),
    ####
    (0.5, 2): dict(points=[0.245, 0.251], decimals=3),
    (0.5, 6): dict(points=[0.207, 0.268], decimals=3),
    (0.5, 12): dict(points=[0.211, 0.374], decimals=3),
    ####
    (0.28, 2): dict(points=[0.117, 0.120], decimals=3),
    (0.28, 6): dict(points=[0.093, 0.134], decimals=3),
    (0.28, 12): dict(points=[0.096, 0.213], decimals=3),
}
