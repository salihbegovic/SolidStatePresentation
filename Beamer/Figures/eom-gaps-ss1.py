...
yticks_translation = {
    # (omega, N)
    (1.0, 2): dict(points=[1.003, 1.01], decimals=3),
    (1.0, 6): dict(points=[0.565, 0.663], decimals=3),
    (1.0, 12): dict(points=[0.533, 0.775], decimals=3),
    ####
    (0.5, 2): dict(points=[0.502, 0.506], decimals=3),
    (0.5, 6): dict(points=[0.233, 0.31], decimals=3),
    (0.5, 12): dict(points=[0.233, 0.406], decimals=3),
    ####
    (0.28, 2): dict(points=[0.281, 0.283], decimals=3),
    (0.28, 6): dict(points=[0.104, 0.164], decimals=3),
    (0.28, 12): dict(points=[0.117, 0.241], decimals=3),
}
